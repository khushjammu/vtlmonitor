...
class TranstarMonitor(BaseMonitor):
  ...
  def check_if_different(self):
    ...
    scraped_text = list(soup.table.children)[-2].text # text in the last row of the table (should be the latest date available)
